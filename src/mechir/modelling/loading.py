...
def convert_hf_model_config(model_name: str, **kwargs):
    ...
    elif architecture == "ElectraModel":
        cfg_dict = {
            "d_model": hf_config.hidden_size,
            "d_head": hf_config.hidden_size // hf_config.num_attention_heads,
            "n_heads": hf_config.num_attention_heads,
    ...
    elif architecture == "ElectraForSequenceClassification":
        cfg_dict = {
            "d_model": hf_config.hidden_size,
            "d_head": hf_config.hidden_size // hf_config.num_attention_heads,
            "n_heads": hf_config.num_attention_heads,
    ...
    **kwargs,
    ...
    if (
        ...
        if cfg.original_architecture == "GPT2LMHeadModel":
            ...
            state_dict = convert_bert_weights(hf_model, cfg, sequence_classification=True)
        elif cfg.original_architecture == "ElectraForSequenceClassification":
            state_dict = convert_electra_weights(hf_model, cfg)
